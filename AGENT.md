...
.spec/
  ...
  design-systems/           # Design system definitions for UI work
    <design>/
...
| Design | `/speci5-design` | Create or update design systems in `.spec/design-systems/` |
| Spec | `/speci5-spec` | Transform PRD features into feature and story specs |
| Plan | `/speci5-plan` | Create concrete implementation tasks from a story |
| Implement | `/speci5-implement` | Implement a story's tasks using worktree-isolated agents |
